    ...
    <div class="container mt-5">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('content.webseries.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 text-center">
                            ...
                            <div class="border rounded p-2 mb-2 bg-light" style="width: 320px; height: 180px; display: flex; justify-content: center; align-items: center; margin: 0 auto; border: 2px dashed #007bff;">
                                <img id="thumbnail_preview" src="{{ asset('images/default-thumbnail.png') }}" style="max-width: 300px; max-height: 160px; object-fit: contain;" />
                            </div>
                        ...
                        <div class="col-md-6 text-center">
                            ...
                            <div class="border rounded p-2 mb-2 bg-light" style="width: 120px; height: 180px; display: flex; justify-content: center; align-items: center; margin: 0 auto; border: 2px dashed #28a745;">
                                <img id="poster_preview" src="{{ asset('images/default-poster.png') }}" style="max-width: 100px; max-height: 160px; object-fit: contain;" />
                            </div>
                    ...
                    <button type="submit" class="btn btn-primary">Add WebSeries</button>
                </form>
            </div>
        </div>
    </div>
